...
class ProductComparatorViewModel @Inject constructor(private val productMiddleware: ProductMiddleware)
    ...
    private var _state = MutableStateFlow<ProductComparatorState>(ProductComparatorState
        .Success(emptyList()))
    ...
    fun searchProduct(productKeyword: String) {
        viewModelScope.launch {
            ...
            val products = withContext(Dispatchers.IO) { productMiddleware.getProducts(productKeyword)}
