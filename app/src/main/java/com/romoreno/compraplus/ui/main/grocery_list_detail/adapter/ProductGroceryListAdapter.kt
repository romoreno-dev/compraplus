...
/**
 * Adapter del RecyclerView del listado de productos incluidos en una lista de la compra
 *
 * @author: Roberto Moreno
 */
class ProductGroceryListAdapter(
    private val whenProductGroceryListItemSelected: WhenProductGroceryListItemSelected,
